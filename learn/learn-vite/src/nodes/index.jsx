...
export const initialNodes = [
  ...
  { id: "c", type: "position-logger", position: { x: 200, y: 200 }, data: { title: "What are partitions?", subtitle: "Partitions in Kafka are the fundamental units of parallelism and scalability within a topic." }, style: style},
  {
    id: "d",
    type: "position-logger",
    position: { x: 0, y: 400 },
